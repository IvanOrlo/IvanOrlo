...
public class PersonalAreaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clearDb = findViewById(R.id.clearDb);
...
// тыкаем и смотрим инфу книги
        adapter.setClickListener(new BookAdapter.ItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                intent.putExtra("isFree", book.isFree());
        ...
        //переходим в лич кабинет
        avatar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(PersonalAreaActivity.this, UserActivity.class);
                startActivity(intent);
